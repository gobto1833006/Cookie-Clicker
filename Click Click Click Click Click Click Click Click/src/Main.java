...
public class Main extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        Label prix2 = new Label("3");
        Label prix3 = new Label("8");
        Label prix4 = new Label("10");
        Label prix5 = new Label("1000");
        ...
        Label multiplieur5 = new Label("10");
        ...
        final Timeline timeline = new Timeline(new KeyFrame(Duration.millis(Double.parseDouble(clicSeconde.getText())), n -> incrementer(bouton, clics)));
        ...
        upgrade4.setOnAction(event -> {
            ...
            timeline.stop();
            timeline.getKeyFrames().setAll(new KeyFrame(Duration.millis(Double.parseDouble(clicSeconde.getText())*1000), n -> incrementer(bouton, clics)));
            timeline.play();
        ...
        Group groupe = new Group(clics, bouton, upgrade1, upgrade2, upgrade3, upgrade4, upgrade5, clicSeconde);
    ...
    public static void incrementer(Button bouton, Label clics) {
